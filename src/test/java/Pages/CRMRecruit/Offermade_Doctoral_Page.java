...
import java.net.MalformedURLException;
    ...
    public class Offermade_Doctoral_Page extends Driver_Init {

        public Offermade_Doctoral_Page(WebDriver driver) {
        ...
        @FindBy(xpath = "//label[@id='Research Topic_label']")
        public static WebElement researchTopic;

        @FindBy(xpath = "//label[@id='Research Supervisor Name_label']")
        public static WebElement supervisorName;

        @FindBy(xpath = "//label[@id='Research Supervisor CID_label']")
        public static WebElement superviserCID;

        @FindBy(xpath = "//input[@id='elcn_ucas_researchstartdate_iDateInput']")
        public static WebElement researchstartDate;

        @FindBy(xpath = "//label[@id='Research End Date_label']")
        public static WebElement researchEndDate;
...
//            ApplicationEnviroment.App.NavigationPage("CRM_TEST");
        ...
        public void searchRecordForOffer() throws Exception {
            ...
            searchClick.click();
            searchTextBox.sendKeys("novSixteen"); //This record is available in TEST
            Thread.sleep(2000);
        ...
        public void fillTheRequiredfieldsForOfferMade() throws Exception {
            ...
            Thread.sleep(3000);
            actions.moveToElement(feeStatus).sendKeys("Home").sendKeys(Keys.ENTER).build().perform();
            Thread.sleep(2000);
        ...
        public void checkBoxSendToDepartment() throws Exception {
            ...
            actions1.moveToElement(researchTopic).click().sendKeys("abc").sendKeys(Keys.ENTER).build().perform();
            Thread.sleep(2000);
            actions1.sendKeys(Keys.ENTER).build().perform();

            actions1.moveToElement(supervisorName).click().sendKeys("xyz").sendKeys(Keys.ENTER).build().perform();
            Thread.sleep(2000);
            actions1.sendKeys(Keys.ENTER).build().perform();

            actions1.moveToElement(researchstartDate).click().sendKeys("15/11/2018").sendKeys(Keys.ENTER).build().perform();
            Thread.sleep(2000);
            actions1.sendKeys(Keys.ENTER).build().perform();

            actions1.moveToElement(researchEndDate).click().sendKeys("13/02/2019").sendKeys(Keys.ENTER).build().perform();
            Thread.sleep(2000);
            actions1.sendKeys(Keys.ENTER).build().perform();
